...
#ifdef PAIR_CLASS
// clang-format off
PairStyle(uf3/mix,PairUF3mix);
// clang-format on
#else

#ifndef LMP_PAIR_UF3_H_mix
#define LMP_PAIR_UF3_H_mix

#include "pair.h"

namespace LAMMPS_NS {

class PairUF3mix : public Pair {
 public:
  PairUF3mix(class LAMMPS *);
  ~PairUF3mix() override;
 ...
 protected:
  ...
  int (PairUF3mix::*get_starting_index_2b)(int i, int j, double r);
  int (PairUF3mix::*get_starting_index_3b)(int i, int j, int k, double r, int knot_dim);
